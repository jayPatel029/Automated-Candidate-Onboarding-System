class Config {
  ...
  static const String productionBaseUrl = 'https://parser-v1-backend.onrender.com';
  ...
  static String get llmProcessEndpoint => '$baseUrl/'; // todo: update this to the correct endpoint
